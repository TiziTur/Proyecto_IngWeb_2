...
(function () {
  ...
  var replacements = [
    ...
    ['Tus credenciales no se muestran en pantalla. Usa cuentas temporales para pruebas y verifica el flujo completo por correo.', 'Your credentials are not shown on screen. Use temporary accounts for testing and verify the full flow by email.'],
